...
GRANT CONNECT ON DATABASE lab02 TO gerente_calidad;

GRANT CONNECT ON DATABASE lab02 TO inspector;

GRANT CONNECT ON DATABASE lab02 TO compras;

GRANT CONNECT ON DATABASE lab02 TO auditor;
