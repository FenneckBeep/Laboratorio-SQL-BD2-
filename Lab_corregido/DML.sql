-- ============================================================================
-- DML: INSERCIÓN DE DATOS DE PRUEBA COMPLETO
...
(ID_Control, Descripcion, Hora, fecha, Valor_Medido, ID_TipoControl, ID_Empleado, ID_Lote, ID_Estado, ID_Rechazo)
VALUES
...
(303, 'Control de humedad superó el límite crítico del 5%', '14:00:00', '2025-05-15', '7.2%', 2, 30, 9003, 3, 3),

(304, 'pH ligeramente fuera de rango', '09:00:00', '2025-06-01', '6.1', 1, 10, 9004, 2, NULL),

(305, 'Reinspección: contaminación detectada', '15:00:00', '2025-06-02', '5.8', 1, 20, 9004, 3, 1),

(306, 'Sellado correcto', '10:30:00', '2025-06-05', 'Conforme', 3, 20, 9005, 1, NULL),

(307, 'Humedad fuera del rango', '11:45:00', '2025-06-10', '8.1%', 2, 30, 9006, 3, 3),

(308, 'Posible presencia de alérgeno', '08:20:00', '2025-06-15', 'Pendiente', 4, 10, 9007, 2, NULL),

(309, 'Reinspección aprobada', '16:00:00', '2025-06-16', 'Negativo', 4, 20, 9007, 1, NULL);
